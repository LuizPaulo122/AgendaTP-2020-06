	...
	)
{
	...
	std:: cout <<"informe o dia que deseja alterar: ";
	std::cin >>dia;
	
	std:: cout <<"informe o mês que deseja alterar: ";
	std::cin >>mês;
	
	std:: cout <<"informe o ano que deseja alterar";
	std::cin >>ano;
	
	std:: cout <<"Altere a descrição: ";
	std::cin >>descrição;
